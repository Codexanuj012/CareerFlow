...
const NAV_ITEMS = [
  ...
  { to: '/compose', label: 'Compose Email', icon: 'M12 20h9M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4Z' },
  { to: '/outreach', label: 'Outreach', icon: 'M22 2 11 13M22 2l-7 20-4-9-9-4Z' },
  { to: '/analytics', label: 'Analytics', icon: 'M3 3v18h18M18 17V9M13 17V5M8 17v-3' },
  { to: '/integrations', label: 'Integrations', icon: 'M9 3H5a2 2 0 0 0-2 2v4m18 0V5a2 2 0 0 0-2-2h-4m0 18h4a2 2 0 0 0 2-2v-4M3 15v4a2 2 0 0 0 2 2h4' },
  { to: '/settings', label: 'Settings', icon: 'M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z M19.4 15a1.7 1.7 0 0 0 .34 1.87l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.7 1.7 0 0 0-1.87-.34 1.7 1.7 0 0 0-1 1.55V21a2 2 0 1 1-4 0v-.09A1.7 1.7 0 0 0 9 19.4a1.7 1.7 0 0 0-1.87.34l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06A1.7 1.7 0 0 0 4.6 15a1.7 1.7 0 0 0-1.55-1H3a2 2 0 1 1 0-4h.09A1.7 1.7 0 0 0 4.6 9a1.7 1.7 0 0 0-.34-1.87l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06A1.7 1.7 0 0 0 9 4.6a1.7 1.7 0 0 0 1-1.55V3a2 2 0 1 1 4 0v.09a1.7 1.7 0 0 0 1 1.55 1.7 1.7 0 0 0 1.87-.34l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06A1.7 1.7 0 0 0 19.4 9a1.7 1.7 0 0 0 1.55 1H21a2 2 0 1 1 0 4h-.09a1.7 1.7 0 0 0-1.51 1Z' },
];
  ...
  return (
    <div className="flex h-full flex-col bg-card">
      ...
      <div className="space-y-3 border-t border-border p-4">
        <NavLink to="/profile" onClick={onNavigate} className="focus-ring flex items-center gap-2.5 rounded-lg p-1.5 hover:bg-white/5">
          <Avatar name={user?.name ?? 'You'} color={user?.avatarColor} />
        ...
        <div className="flex items-center gap-2 rounded-lg bg-card-secondary px-3 py-2 text-xs">
          <span className={`h-1.5 w-1.5 rounded-full ${connected ? 'bg-success' : developmentMode ? 'bg-warning' : 'bg-muted'}`} aria-hidden />
          <span className="text-muted">
            Gmail: {connected ? 'Connected' : developmentMode ? 'Dev Mode' : 'Not Connected'}
          </span>
        </div>
